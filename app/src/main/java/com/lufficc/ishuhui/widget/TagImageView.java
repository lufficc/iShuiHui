...
public class TagImageView extends ImageView {
    ...
    public TagImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TagImageView, defStyleAttr, 0);
        mTagOrientation = a.getInteger(R.styleable.TagImageView_simple_tag_orientation, 0);
        mTagWidth = a.getDimensionPixelSize(R.styleable.TagImageView_simple_tag_width, dip2px(DEFAULT_TAG_WIDTH));
        mCornerDistance = a.getDimensionPixelSize(R.styleable.TagImageView_simple_corner_distance, dip2px(DEFAULT_CORNER_DISTANCE));
        mTagBackgroundColor = a.getColor(R.styleable.TagImageView_simple_tag_background_color, DEFAULT_TAG_BACKGROUND_COLOR);
        mTagText = a.getString(R.styleable.TagImageView_simple_tag_text);
        mTagTextSize = a.getDimensionPixelSize(R.styleable.TagImageView_simple_tag_textSize, dip2px(DEFAULT_TAG_TEXT_SIZE));
        mTagTextColor = a.getColor(R.styleable.TagImageView_simple_tag_textColor, DEFAULT_TAG_TEXT_COLOR);
        mTagEnable = a.getBoolean(R.styleable.TagImageView_simple_tag_enable, true);
        mRoundRadius = a.getDimensionPixelSize(R.styleable.TagImageView_simple_tag_round_radius, 0);
        a.recycle();
